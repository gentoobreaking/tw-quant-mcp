...
### 監理／風險（僅遠端 🔵）
market_disposal_stocks、disposition_securities_period、information_disclosure_violations、financial_program_abnormal_recommendations、quarterly_audit_variance、earnings_forecast_achievement

> 已補齊：get_company_sec_regulatory_penalties（T106，本機同名工具，TWSE-API t187ap22_L）
