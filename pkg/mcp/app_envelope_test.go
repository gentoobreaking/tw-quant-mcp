...
func stubBCEnvelope(f *fakeFetch) {
	...
	f.bodies["otc_after_hours|"] = `[{"Date":"1150825","SecuritiesCompanyCode":"00679B","CompanyName":"元大美債20年","Close":"25.89","Transactions":"7","TradeVolume":"11","TradeAmount":"284790"}]`
	f.bodies["otc_warn_note|"] = `[{"Date":"20260825","SecuritiesCompanyCode":"3362","CompanyName":"先進光","AccumulationSituation":"115年08月20日至115年08月25日連續四次"},{"Date":"20260825","SecuritiesCompanyCode":"702281","CompanyName":"精測元大5C購01","AccumulationSituation":"115年08月24日至115年08月25日連續二次"}]`
	f.bodies["emerging_quotes|"] = `[{"Date":"1150825","SecuritiesCompanyCode":"1260","CompanyName":"富味鄉","LatestPrice":"31","TransactionVolume":"23805"}]`
	f.bodies["emerging_highlight|"] = `[{"Date":"1150825","RegisteredStocksNumber":"361","TotalMarketValue":"1579523"}]`
	f.bodies["emerging_eps_rank|"] = `[{"Date":"1150825","Rank":"1","SecuritiesCompanyCode":"7861","CompanyName":"貝爾威勒","EPS":"22.85"}]`
	...
	f.bodies["wcb_issue|"] = `[{"Date":"1150601","Code":"70006C","Name":"元債20富邦56牛01","UnderlyingStockCode":"00679B"}]`
	f.bodies["wxy_daily|"] = `[{"Date":"1090312","Code":"70005X","Name":"精華元大66展02","Close":"3.4"}]`
	f.bodies["rank_pe|"] = `[{"Date":"1150825","Rank":"1","SecuritiesCompanyCode":"4523","CompanyName":"永彰","ClosePrice":"23.90"}]`
	...
	f.bodies["intl_bond_quotes|"] = `[{"Date":"20260825","BondCode":"F00922","BondName":"P21BNP2","BidYieldPrice":"099.9000"}]`
	f.bodies["bond_issue|"] = `[{"Date":"20260825","IssuerName":"中央政府","BondCode":"A90105"}]`
	f.bodies["gold_latest|"] = `[{"Date":"1150825","GoldCode":"AU9901","GoldShortName":"臺銀金"}]`
	f.bodies["gold_warrant|"] = `[{"Date":"1070917","Code":"70001Y","Name":"一銀金元大63展01"}]`
	f.bodies["opfund_latest|"] = `[{"Date":"1150825","SecurityCode":"T1001Y","ListedOpenEndedFund":"富邦FB","PreNAV":"49.81"}]`
	f.bodies["opfund_dealer|"] = `[{"Date":"1150825","SecurityCode":"T1001Y","SecurityName":"富邦FB","MarketMakerCode":"960T"}]`
	f.bodies["gisa_company|"] = `[{"Date":"1150825","SecuritiesCompanyCode":"7430","CompanyName":"凱鑫"}]`
	f.bodies["gisa_financing|"] = `[{"Date":"1141028","SecuritiesCompanyCode":"7670","CompanyName":"淞康"}]`
	f.bodies["otc_mopsfin|kind=187ap17_O"] = `[{"Date":"1150825","SecuritiesCompanyCode":"1240","CompanyName":"茂生農經","營業利益(虧損)":"1,234"}]`
...
func allToolProbes() []envelopeProbe {
	return []envelopeProbe{
		...
		{name: "get_time_and_sales", args: map[string]any{"market": "futures"}},
		...
		{name: "get_fx_margin", args: map[string]any{}},
		...
		{name: "get_ssf_overview", args: map[string]any{"kind": "top10", "limit": 3}},
		...
		{name: "get_otc_after_hours", args: map[string]any{"code": "00679B"}},
		{name: "get_otc_warning_note_accumulated", args: map[string]any{"kind": "stock", "name": "先進光"}},
		{name: "get_emerging_quotes", args: map[string]any{"code": "1260"}},
		...
		{name: "get_international_bond", args: map[string]any{"kind": "quotes", "code": "F00922"}},
		{name: "get_gold_spot", args: map[string]any{"kind": "spot", "code": "AU9901"}},
		...
		{name: "get_calendar_spread_trades", args: map[string]any{"kind": "summary", "code": "BRF"}},
